...
Caso ainda não tenha o Conda instalado, siga as instruções [neste link](link para instalar o conda).

Vá até [este link](https://github.com/dalmolingroup/MEDUSA/blob/main/environment.yml) para adquirir o arquivo `environment.yml`.
